...
final class LunarCalendar {
     ...
     * 特殊节日、母亲节和父亲节,感恩节等
     */
    @SuppressLint("UseSparseArrays") private static final Map<Integer, String[]> SPECIAL_FESTIVAL = new HashMap<>();
     ...
     * 保存每年24节气
     */
    @SuppressLint("UseSparseArrays") private static final Map<Integer, String[]> SOLAR_TERMS = new HashMap<>();
