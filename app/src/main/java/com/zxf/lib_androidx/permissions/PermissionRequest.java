...
public final class PermissionRequest {
    ...
    public String toString() {
        return "PermissionRequest{" + "mHelper=" + mHelper + ", mPerms=" + Arrays.toString(mPerms) + ", mRequestCode=" + mRequestCode + ", mRationale='" + mRationale + '\'' + ", mPositiveButtonText='" + mPositiveButtonText + '\'' + ", mNegativeButtonText='" + mNegativeButtonText + '\'' + ", mTheme=" + mTheme + '}';
    }
    ...
    public static final class Builder {
         ...
         */
        public Builder(@NonNull Activity activity, int requestCode, @NonNull @Size(min = 1) String... perms) {
         ...
         */
        public Builder(@NonNull Fragment fragment, int requestCode, @NonNull @Size(min = 1) String... perms) {
         ...
         * @see #Builder(Activity, int, String...)
         */
        public Builder(@NonNull android.app.Fragment fragment, int requestCode, @NonNull @Size(min = 1) String... perms) {
            mHelper = PermissionHelper.newInstance(fragment);
            mRequestCode = requestCode;
            mPerms = perms;
        }
