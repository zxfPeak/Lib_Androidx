...
import com.zxf.lib_androidx.log4j.LogConfig;
...
public class LogUtil {
     ...
     **/
    private static final String APP_NAME = "rihua";

    /**
     * 设置log文件全路径，这里是 MyApp/Log/myapp.log
     **/
    //    private static final String LOG_FILE_PATH = Environment.getExternalStorageDirectory() + File.separator + APP_NAME + File.separator + "Log" + File.separator + APP_NAME.toLowerCase(Locale.CHINA) + ".log";
    private static final String LOG_FILE_PATH = Environment.getExternalStorageDirectory() + File.separator + APP_NAME.toLowerCase(Locale.CHINA) + ".log";
